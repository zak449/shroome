...
- **OG title:** `shroomé — drop 002: your matcha latte is now a beauty step`
- **OG description:** `2g grass-fed collagen + ceremonial matcha in one ready-to-pour sachet. supports skin health. tastes like a treat. drop 001 sold out — get access to drop 002.`
...
Body copy:
> [X₁] boxes went to the access list and disappeared. we don't have a wall of reviews yet — we have a label we'll put next to anyone's, and a line already forming for drop 002.
...
- Drop-access signup → `/api/waitlist` (email step, then optional phone step for SMS early access), `utm_campaign=lp-glow`
- CTA 3x: hero, post-FAQ, final section; ghost page (no nav/exit links except footer legal) — one decision, zero browsing detours
