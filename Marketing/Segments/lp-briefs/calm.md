# Ghost LP Brief — /lp/calm (the coffee breakup)
...
- **Page base:** Cream #FDF4EE, Navy #1B1F3B text — this is the calmest page in the set; let Cream breathe
- **Hero wash:** Dreamy gradient Soft Lavender #E8D5F0 → Blush #FFE0EC, heavier on Lavender (the functional/calm association), generous cloud texture — clouds literally communicate "no crash"
- **Caffeine-curve graphic:** Navy line art on Cream; shroomé curve highlighted with a Lavender #D4B8E0 fill, coffee spike in Navy 40%
- **CTA (all instances):** Lime #C8FF3A, Navy text — the single energetic note on a soft page
...
> break up with the crash. keep the energy.
...
**Eyebrow (Syne 700, uppercase):** CALM, STEADY ENERGY · SUPPORTS SUSTAINED FOCUS
...
## 2. The curve (signature section for this page — place between hero and benefits)

Header (H2): *coffee spikes. matcha carries.*
Visual: simple two-line chart, Navy on Cream. Coffee line: sharp peak at 30 minutes, hard drop by hour 3, dips below baseline. shroomé line: gentler rise, long plateau through hour 5, soft landing. Lavender fill under the shroomé curve. Axis labels: "how it feels" / "hours after your first sip." Label the drop on the coffee line: *the 2pm cliff.* Label the plateau: *the carry.*
Caption (13px): illustrative of typical caffeine + l-theanine absorption character, not a measured clinical result.

---

## 3. Benefit blocks (3-up; Cream cards on Soft Lavender section)

**Block 1 — title:** *the l-theanine difference*
...
**Block 3 — title:** *a drink you'd choose anyway*
...
## 4. Ingredient / science strip (Lavender #D4B8E0 band, Navy text)

Strip header (H2): *what's doing the work*

| Stat | Label |
|---|---|
| ~60mg | caffeine — about half an espresso shot |
| 2.5g | ceremonial matcha — naturally occurring l-theanine, supports sustained focus |
| 200mg | lion's mane fruiting-body extract — ≥70% beta-glucans |
| 2g | grass-fed collagen peptides — along for the ride |

Strip footnote (13px): no added sugar, no artificial anything, no proprietary blends. every dose printed on the sachet.
...
## 8. Footer disclaimer (verbatim, 12px minimum)
