# Ghost LP Brief — /lp/focus (the deep workers)
...
**Block 2 — title:** *the focus pairing that started it all*
...
| Stat | Label |
|---|---|
| 200mg | organic lion's mane — fruiting body, hot-water extracted |
| ≥70% | beta-glucan content — third-party verified (typical market range: 15–30%) |
| 2.5g | ceremonial matcha — first harvest, shade-grown, ~60mg caffeine + natural l-theanine |
| 2g | grass-fed collagen peptides — disclosed like everything else |

Strip footnote (13px): beta-glucans support immune function. no proprietary blends — if it's in the sachet, it's on the label with a number next to it. heavy-metals and microbial tested; made in a GMP-certified facility.
