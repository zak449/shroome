...
export const metadata: Metadata = {
  ...
  description: "The liquid ceremonial matcha latte with lion's mane + collagen. The first run poured out in 9 days. Join the Flock and shop the next run a full day before launch.",
  ...
  openGraph: {
    ...
    description: "The first run poured out in 9 days. Join the Flock and shop the next run a full day before launch.",
    type: "website",
    siteName: "shroomé",
