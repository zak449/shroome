  ...
  return (
    <>
      <style>{`
        ...
        .fs-badge span{font-family:var(--brand-font-mono);font-size:11px;font-weight:600;letter-spacing:.15em;text-transform:uppercase;color:var(--brand-tint-soft)}
        ...
        .fs-cta-primary{display:inline-block;padding:14px 40px;border-radius:8px;background:var(--brand-accent);color:var(--brand-accent-contrast);font-family:var(--brand-font-mono);font-size:12px;font-weight:700;letter-spacing:.1em;text-transform:uppercase;text-decoration:none;transition:transform .15s}
