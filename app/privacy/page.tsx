  ...
  return (
    <>
      <style>{`
        ...
        .pp-nav-links a:hover{color:var(--brand-accent-deep)}
        .pp-nav-cta{
        ...
        .pp-nav-cta:hover{background:var(--brand-accent-muted-deep)}
        ...
        .pp-hero-tag::before{content:'';width:6px;height:6px;border-radius:50%;background:var(--brand-accent);flex-shrink:0}
        .pp-hero h1{
        ...
        .pp-hero-sub strong{color:var(--brand-ink);font-weight:700}
        ...
        .pp-updated{font-family:var(--brand-font-mono);font-size:11px;color:rgba(var(--brand-ink-rgb),0.4);letter-spacing:.06em;margin-bottom:32px}
        .pp-body p{font-family:var(--brand-font-body);font-size:14px;color:rgba(var(--brand-ink-rgb),0.7);line-height:1.8;margin-bottom:16px;font-weight:400;max-width:680px}
        ...
        .pp-body ul{font-family:var(--brand-font-body);font-size:14px;color:rgba(var(--brand-ink-rgb),0.7);line-height:1.8;margin-bottom:16px;padding-left:24px;max-width:680px}
        .pp-body ul li{margin-bottom:8px}
        .pp-body ul li strong{color:var(--brand-ink);font-weight:600}

        /* ── CTA SECTION ─── */
        .pp-cta{background:var(--brand-ink);padding:64px 7%;text-align:center;position:relative;overflow:hidden}
        .pp-cta::before{content:'';position:absolute;top:-1px;left:0;right:0;height:20px;background:radial-gradient(circle at 50% 0, var(--brand-canvas) 0 10px, transparent 10.5px) top left/40px 20px repeat-x;pointer-events:none}
        ...
        .pp-btn-cta:hover{background:var(--brand-accent-muted-deep);transform:translateY(-2px)}
        ...
        .pp-footer-top a:hover{color:var(--brand-accent-deep)}
        .pp-footer-mid{font-size:12px;color:rgba(var(--brand-ink-rgb),0.45);margin-bottom:8px}
        .pp-footer-mid a{color:rgba(var(--brand-ink-rgb),0.45);text-decoration:underline;transition:color .2s}
        .pp-footer-mid a:hover{color:var(--brand-ink)}
        .pp-footer-bot{font-family:var(--brand-font-mono);font-size:10px;color:rgba(var(--brand-ink-rgb),0.45);letter-spacing:.08em}
