  ...
  return (
    <>
      <style>{`
        ...
        .tos-nav-logo span{font-family:var(--brand-font-display);font-size:22px;font-weight:400;font-style:italic;color:var(--brand-ink)}
        ...
        .tos-hero-overlay{position:absolute;inset:0;background:linear-gradient(rgba(var(--brand-flavor-strawberry-rgb),0.7) 0%,rgba(var(--brand-flavor-strawberry-rgb),0.5) 40%,rgba(var(--brand-canvas-rgb),0.6) 100%)}
        ...
        .tos-hero h1 em{font-style:italic;color:var(--brand-accent-warm)}
        .tos-hero-sub{
