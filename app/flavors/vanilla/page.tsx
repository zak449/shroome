  ...
  return (
    <>
      ...
      <style>{`
        ...
        .vf-nav-links a:hover{color:var(--brand-accent-deep)}
        .vf-nav-cta{
        ...
        .vf-label::after{content:'';flex:1;height:1px;background:rgba(var(--brand-ink-rgb),0.12)}
        ...
        /* ── FOOTER ── */
        .vf-footer{background:var(--brand-flavor-functional);padding:32px 6%;text-align:center;border-top:1px solid rgba(var(--brand-ink-rgb),0.06)}
        ...
        .vf-footer-top a:hover{color:var(--brand-accent-deep)}
        .vf-footer-mid{font-size:12px;color:rgba(var(--brand-ink-rgb),0.45);margin-bottom:8px}
        .vf-footer-mid a{color:rgba(var(--brand-ink-rgb),0.45);text-decoration:underline;transition:color .2s}
        .vf-footer-mid a:hover{color:var(--brand-ink)}
        .vf-footer-bot{font-family:var(--brand-font-mono);font-size:10px;color:rgba(var(--brand-ink-rgb),0.45);letter-spacing:.08em}
        ...
        <section className="vf-hero">
          ...
          <div className="vf-hero-inner">
            <Image
              ...
              priority
            />
            <div className="vf-hero-tag">Flavor Profile &middot; First run poured out</div>
            <h1>Vanilla</h1>
            <p className="vf-hero-desc">
              ...
              came from your favorite caf&eacute;. But it&apos;s ready the second you stir.
            </p>
            <a
              href="/#signup"
              style={{
